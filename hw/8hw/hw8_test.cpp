...
void smallTest(std::ofstream& outfile) {
	cout << "starting small test " << endl;
	BPlusTree<int> b1(3);
	b1.insert(11);
	assert(b1.find(11)->contains(11));
	outfile << "insert done on: " << 11 << std::endl;

	b1.insert(15);
	assert(b1.find(15)->contains(15));
	outfile << "insert done on: " << 11 << std::endl;

	b1.insert(14);
	assert(b1.find(14)->contains(14));
	outfile << "insert done on: " << 11 << std::endl;

	b1.insert(16);
	assert(b1.find(16)->contains(16));
	outfile << "insert done on: " << 16 << std::endl;

	b1.insert(19);
	assert(b1.find(19)->contains(19));
	outfile << "insert done on: " << 19 << std::endl;
...
int main(){
	...
	*/
	...
	//smallTest(outfile);
	//outfile << "smallTest() complete!" << std::endl;
